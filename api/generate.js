...
## 학습 목표 (반드시 아래 이름을 섹션명 s에 그대로 사용)
${goals.map(g => `- "${g.name}"`).join('\n')}

## 출력 형식 (JSON만, 설명 없이)
{
  "1": [{"s":"토익","t":"구체적 태스크 (30-60분 분량)"}, {"s":"코테","t":"..."}],
  "2": [...],
  ...
}
...
2. 목표별 가용 시간을 균등하게 배분
3. 섹션명(s)은 반드시 위 목표 이름 중 하나 (임의로 바꾸지 말 것)
4. 태스크는 한국어, 구체적·실행 가능하게 (추상적 표현 금지)
5. 같은 날 동일 태스크 반복 금지 — 다양하게
